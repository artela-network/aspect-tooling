        ...
        JSON.stringify(
          {
            ...
            scripts: {
              ...
              'asbuild:debug': 'asc aspect/index.ts --transform ./transform.mjs --disable bulk-memory -O0 --debug --runtime stub --exportRuntime --exportStart __aspect_start__ --target debug --disable bulk-memory --optimize --debug --runtime stub --exportRuntime --exportStart __aspect_start__',
              'asbuild:release': 'asc aspect/index.ts --transform ./transform.mjs --disable bulk-memory -O3 --noAssert --runtime stub --exportRuntime --exportStart __aspect_start__ --target release --disable bulk-memory --optimize --debug --runtime stub --exportRuntime --exportStart __aspect_start__',
