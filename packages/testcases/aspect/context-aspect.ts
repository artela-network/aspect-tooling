    ...
    ITransactionVerifier
{
  verifyTx(input: TxVerifyInput): Uint8Array {
    ...
    sys.log(
      logPrefix + ' ' + 'env.allowUnprotectedTxs' + ' ' + allowUnprotectedTxsData.data.toString(),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.chain.homesteadBlock' + ' ' + homesteadBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.chain.daoForkSupport' + ' ' + daoForkSupportData.data.toString(),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.chain.byzantiumBlock' + ' ' + byzantiumBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix +
        ...
        ' ' +
        constantinopleBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.chain.petersburgBlock' + ' ' + petersburgBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.chain.istanbulBlock' + ' ' + istanbulBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.chain.muirGlacierBlock' + ' ' + muirGlacierBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix +
        ...
        ' ' +
        arrowGlacierBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.chain.grayGlacierBlock' + ' ' + grayGlacierBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix +
        ...
        ' ' +
        mergeNetSplitBlockData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.consensusParams.block.maxGas' + ' ' + blockGasData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.consensusParams.block.maxBytes' + ' ' + maxBytesData.data.toString(10),
    );

    const maxAgeDuration = sys.hostApi.runtimeContext.get(
    ...
    sys.log(
      logPrefix +
        ...
        'env.consensusParams.evidence.maxAgeDuration' +
        ' ' +
        maxAgeDurationData.data.toString(10),
    );

    const maxAgeNumBlocks = sys.hostApi.runtimeContext.get(
    ...
    sys.log(
      logPrefix +
        ...
        'env.consensusParams.evidence.maxAgeNumBlocks' +
        ' ' +
        maxAgeNumBlocksData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix +
        ...
        ' ' +
        envMaxBytesData.data.toString(10),
    );
    ...
    sys.log(
      logPrefix + ' ' + 'env.consensusParams.appVersion' + ' ' + appVersionData.data.toString(10),
    );
  ...
  preTxExecute(input: PreTxExecuteInput): void {
    ...
    sys.log(
      logPrefix +
        ...
        ' ' +
        uint8ArrayToHex(transactionsRootData.data),
    );
    ...
    for (let i = 0; i < accessListData.accessList.length; i++) {
      sys.log(
        logPrefix +
          ...
          i.toString(10) +
          ' ' +
          uint8ArrayToHex(accessListData.accessList[i].address),
      );
    }
  ...
  postTxExecute(input: PostTxExecuteInput): void {
    ...
    for (let i = 0; i < logsData.logs.length; i++) {
      sys.log(
        logPrefix +
          ...
          i.toString(10) +
          ' ' +
          uint8ArrayToHex(logsData.logs[i].address) +
          ' ' +
          uint8ArrayToHex(logsData.logs[i].data),
      );
    }
    ...
    sys.log(
      logPrefix + ' ' + 'receipt.cumulativeGasUsed' + ' ' + cumulativeGasUsedData.data.toString(10),
    );
