...
// SPDX-License-Identifier: GPL-3.0-only AND GPL-3.0 AND MIT
...
// File @openzeppelin/contracts/token/ERC777/IERC777Recipient.sol@v4.8.0
...
// File @openzeppelin/contracts/proxy/utils/UUPSUpgradeable.sol@v4.8.0
...
// File contracts/samples/AspectEnabledSimpleAccount.sol
...
// File contracts/samples/AspectEnabledSimpleAccountFactory.sol
 ...
 */
contract AspectEnabledSimpleAccountFactory {
    AspectEnabledSimpleAccount public immutable accountImplementation;

    constructor(IEntryPoint _entryPoint) {
        accountImplementation = new AspectEnabledSimpleAccount(_entryPoint);
    }
     ...
     */
    function createAccount(address owner,uint256 salt) public returns (AspectEnabledSimpleAccount ret) {
        address addr = getAddress(owner, salt);
        uint codeSize = addr.code.length;
        if (codeSize > 0) {
            return AspectEnabledSimpleAccount(payable(addr));
        }
