...
export function encodeJitInherentRequest(message: JitInherentRequest): Uint8Array {
  return Protobuf.encode(message, JitInherentRequest.encode);
}

export function decodeJitInherentRequest(buffer: Uint8Array): JitInherentRequest {
  return Protobuf.decode<JitInherentRequest>(buffer, JitInherentRequest.decode);
}
