...
export function encodeEthCallMessage(message: EthCallMessage): Uint8Array {
  return Protobuf.encode(message, EthCallMessage.encode);
}

export function decodeEthCallMessage(buffer: Uint8Array): EthCallMessage {
  return Protobuf.decode<EthCallMessage>(buffer, EthCallMessage.decode);
}
