...
export class ChainConfig {
  static encode(message: ChainConfig, writer: Writer): void {
    ...
    writer.uint32(144);
    writer.uint64(message.shanghaiTime);

    writer.uint32(152);
    writer.uint64(message.cancunTime);

    writer.uint32(160);
    writer.uint64(message.pragueTime);
  ...
  static decode(reader: Reader, length: i32): ChainConfig {
    ...
    while (reader.ptr < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 18:
          message.shanghaiTime = reader.uint64();
          break;

        case 19:
          message.cancunTime = reader.uint64();
          break;

        case 20:
          message.pragueTime = reader.uint64();
          break;
  ...
  constructor(
    ...
    this.cancunTime = cancunTime;
    this.pragueTime = pragueTime;
