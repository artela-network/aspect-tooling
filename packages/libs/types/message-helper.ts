...
export function NewAspectResponse(success: bool, msg: string, typeUrl: string, data: Any): AspectResponse {
    const runResult = new RunResult(success, msg);
    return new AspectResponse(runResult, typeUrl, data);
}

export function NewDataResponse<TMessage>(success: bool, msg: string, typeUrl: string, message: TMessage, encoder: (message: TMessage, writer: Writer) => void): AspectResponse {
    const runResult = new RunResult(success, msg);
...
export function ToAny<TMessage>(typeUrl: string, message: TMessage, encoder: (message: TMessage, writer: Writer) => void): Any {
